...
public class Conexion {
    ...
    //--------------------------------------------------------------------------
    //-------- Muestra el resultado de una consulta en una JTable adaptando el tama�o de las columnas
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    //-------- regresa el valor de una consulta de un solo dato del tipo imagen
    //-------- si el resultado es una imagen nula, significa que la consulta ha
    //-------- regresado una tabla vacia o el codigo SQL es incorrecto
    //--------------------------------------------------------------------------
    public ImageIcon obtenerImagen(String consulta) {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery(consulta);
            while (rs.next()) {
                resultado = new ImageIcon(rs.getBytes(1));
            }
            return resultado;
        } catch (Exception e) {
            return resultado;
    ...
    //--------------------------------------------------------------------------
    public String toSQL(Date fecha) {
    ...
    public int ejecutarReporte(String archivo, Map parametro) {
        try {
            ...
            JasperViewer jviewer = new JasperViewer(jasperPrint, false);//Se lanza el Viewerde Jasper, no termina aplicación al salir
